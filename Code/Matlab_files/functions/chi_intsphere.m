...
% based on the acquisition model on MRI devises instead of sampling the functions.
%
% Parameters:
% FOV: field of view in x, y, and z directions
% N: no of samples in kx, ky, kz
% center: center of the sphere (cx,cy,cx)
...
%
% Output:
% chi: per voxel integrated susceptibility distribution (bulk susceptibility)
% Bnuc: bulk analytic nuclear magnetic field (using the Lorent's sphere approximation)
%       This includes intravoxel dephasing effects.
%
%
